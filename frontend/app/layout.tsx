...
import { AuthGuard } from "@/app/auth/components/AuthGuard"; // <-- L'import dyal l'Videur dyalna
...
export default function RootLayout({
  ...
  return (
    <html lang="fr" suppressHydrationWarning>
      ...
      >
        {/* L'AuthGuard ghadi y-ghllef l'app kamla. Ila makaynch token, ghay-biyen <AuthForm />. Ila kayn, ghay-khellih ydouz */}
        <AuthGuard>
        ...
        {/* Toasts / notifications (nkhaliwhom bera l'AuthGuard bach n9drou n-affichiwhom hta f page d login ila bghina) */}
        <ToastProvider />
      </body>
    </html>
  );
